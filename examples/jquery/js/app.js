...
jQuery(function ($) {
	...
	var App = {
		...
		update: function (e) {
    		...
    		/* Fixed bug that destroyed Todo when keyup ESCAPE occurs with an empty field:
    		.destroy will now only destroy Todo if abort is false. 
    
    		Note that Todo will still be destroyed if any other
    		focusout event occurs and the field is empty. (such as clicking outside of the field) */
